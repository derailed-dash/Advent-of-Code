...
while frontier:
    (r,c,t,got_end,got_start) = frontier.popleft()
    ...
    if (r,c) not in BAD:
        frontier.append((r,c,t+1,got_end,got_start))
    if (r+1,c) not in BAD:
        frontier.append((r+1, c, t+1,got_end,got_start))
    if (r-1,c) not in BAD:
        frontier.append((r-1, c, t+1,got_end,got_start))
    if (r,c+1) not in BAD:
        frontier.append((r, c+1, t+1,got_end,got_start))
    if (r,c-1) not in BAD:
        frontier.append((r, c-1, t+1,got_end,got_start))
