...
This solution is nearly identical to the previous solution.  However, instead of using custom `Point` and `Vector` classes, I'm storing all points and vectors as **complex numbers**.
