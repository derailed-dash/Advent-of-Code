...
- Compute the 9 different grids we can make, by adding risk scores to our original grid. Since each location can only have a score 1 through 9, there are only 9 possible variants. 
- Stich tiles to the right, to make a row 5 tiles wide.
