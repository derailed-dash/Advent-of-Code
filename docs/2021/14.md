...
E.g. Template:   <red>N</red>       <ylw>N</ylw>       <cyn>C</cyn>       B
     Step 1:     <red>N   C</red>   <ylw>N   B</ylw>   <cyn>C   H</cyn>   B
     Step 2:     <red>N B C C</red> <ylw>N B B B</ylw> <cyn>C B H C</cyn> B  
</pre>
...
<pre class="language-plaintext highlighter-rouge highlight">
Initial pair:         <ylw>X</ylw> <cyn>Y</cyn>
Resulting product:   <ylw>X</ylw> <mag>A</mag> <cyn>Y</cyn>
Which is two pairs: <ylw>X</ylw><mag>A</mag> + <mag>A</mag><cyn>Y</cyn>
</pre>
