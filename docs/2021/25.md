...
```text
22:06:27.861:DEBUG:__main__:    Created Grid
22:06:32.699:INFO:__main__:     We've stopped migrating at iteration 360
22:06:32.706:INFO:__main__:     Execution time: 4.8858 seconds
```
...
- The new `setup_fig()` method:
  - Establishes the size of the plot, in pixels. This will be the size of our rendered frames, e.g. 800x600 pixels.
