...
- [Simplify Complex Numbers with Python](https://realpython.com/python-complex-numbers/){:target="_blank"}
- [Python List Comprehension](https://www.geeksforgeeks.org/python-list-comprehension/){:target="_blank"}
