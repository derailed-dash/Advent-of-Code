...
Also of note: I'm using the Python [logging](https://docs.python.org/3/howto/logging.html) module, rather than simply `print()` statements. The advantage of the logging module is that we explicitly specify the "level" for any given logging statement.
