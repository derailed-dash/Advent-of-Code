...
![Plot of Scanners and Beacons]({{"/assets/images/trench_anim_sample.gif" | relative_url }}){:style="width:400px"}

And the animation of the real data looks like this:

![Plot of Scanners and Beacons]({{"/assets/images/trench_anim.gif" | relative_url }}){:style="width:400px"}